...
import { OrganizationModule } from "../src/runtime/organization/module.js";
...
export function flattenForTests(boot: ServerBoot): TestDeps {
  ...
  return {
    ...
    orgService: api("CompanyModule", "Organizations"),
  };
}
...
export interface TestAppOptions {
  ...
  machines?: MachinesService;
  /** Test double: the organization service the company routes call (no scheduler runs). */
...
export function replacementsFor(o: TestAppOptions): Replacements {
  ...
  if (o.organizations) out.push([OrganizationModule, { organizations: o.organizations }]);
  return out;
}
