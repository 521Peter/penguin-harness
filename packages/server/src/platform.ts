...
import { OrgCache, Organizations } from "./mechanisms/organizations.js";
import { OrgCacheRepo } from "./db/repos/organizations.js";
import { OrganizationModule } from "./runtime/organization/module.js";
...
/** Company mode: organizations of Agents — the caches, the runtime that drives them, and its routes. */
@Module({
  children: [OrgCacheRepo, OrganizationModule, OrganizationRoutes],
  exports: [OrgCache, Organizations],
})
